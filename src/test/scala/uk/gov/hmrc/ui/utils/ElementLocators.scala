...
object ElementLocators {
  ...
  val cysPageEmailSentsIn                        =
    "#main-content > div > div > dl > div.govuk-summary-list__row.govuk-summary-list__row--no-actions > dd"
  val cysPageEmailSentsInVerified                =
    "#main-content > div > div > dl:nth-child(3) > div:nth-child(2) > dd.govuk-summary-list__value"
  val cysPageChangeEmailAddressLink              =
    "#main-content > div > div > dl > div:nth-child(2) > dd.govuk-summary-list__actions > a"
  val cysPageChangeEmailAddressVerifiedLink      =
    "#main-content > div > div > dl:nth-child(5) > div > dd.govuk-summary-list__actions > a"
  val cysPageContinueButton                      = "#main-content > div > div > a"
  val cysPageEmailSentInChangeLink               =
    "#main-content > div > div > dl:nth-child(3) > div:nth-child(2) > dd.govuk-summary-list__actions > a"
  val cysPageFixthisLink                         = "#main-content > div > div > dl > div:nth-child(2) > dd.govuk-summary-list__value > p > a"
  val cysPageTaxDocumentsChangeLink              =
    "#main-content > div > div > dl:nth-child(3) > div:nth-child(1) > dd.govuk-summary-list__actions > a"
  ...
  val demoFrontEndInboxFirstMessageSubject       =
    "#sa-messages-table > tbody > tr > td:nth-child(2) > div > span > a > span > span"
  ...
  val cdsMessageDisplayName2                     = "#message-index-1 > span:nth-child(2)"
  val firstReadMessageText                       =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > div > p > span:nth-child(3)"
  val caseWorkerRepliedMessageText               =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > div > div:nth-child(3)"
  ...
  val readConversationStatus: String                  =
    "#main-content > div > div > div.govuk-grid-row > div > div > table > tbody > tr > td.govuk-table__cell.status-align > span"
  val unreadConversationStatus: String                =
    "#main-content > div > div > div.govuk-grid-row > div > div > table > tbody > tr > td.govuk-table__cell.status-align > span.govuk-visually-hidden"
  val replyLinkId: String                             = "reply-link"
  val replySendButton: String                         =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > div > form > button"
  val errorSummary: String                            =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > div > div.govuk-error-summary > div > h2"
  val errorMessage: String                            =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > div > div.govuk-error-summary > div > div > ul > li > a"
  val replyTextId: String                             = "reply-form"
  val backToMessagesButton: String                    =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > form > button"
  val welshLanguageToggle: String                     =
    "#main-content > div > div > div > div > div.govuk-grid-column-two-thirds > form > button"
