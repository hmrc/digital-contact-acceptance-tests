...
trait TestData {
  ...
  val externalRefId: String      = "Test12232434323434"
  ...
  def digitalContactDemoFrontend: String = TestEnvironment.url("demo-frontend")
  def preferences(): String              = TestEnvironment.url("preferences")
  def secureMessage(): String            = TestEnvironment.url("secure-message")
  def externalMessageAdapter(): String   = TestEnvironment.url("external-message-adapter")
