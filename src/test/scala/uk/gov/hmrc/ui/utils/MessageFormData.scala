...
object MessageFormData {
  ...
  def update(
    ...
    formData.copy(
      ...
      contentWelsh = contentWelsh.getOrElse(formData.contentWelsh),
      validFrom = validFrom.getOrElse(formData.validFrom),
      alertQueue = alertQueue.getOrElse(formData.alertQueue),
  ...
  val default: MessageFormData = MessageFormData(
    ...
    contentEnglish = englishContentValue,
    subjectWelsh = englishSubjectValue,
    contentWelsh = englishContentValue,
