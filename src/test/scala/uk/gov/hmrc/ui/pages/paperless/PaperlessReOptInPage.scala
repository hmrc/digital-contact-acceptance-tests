...
import uk.gov.hmrc.ui.ElementLocators.{emailPageHeader2, reOptInPageHeader, reOptInPageSubmitEmailFormHeader, spsReOptIn2Id, spsReOptInId, spsReOptInIdEmailId, submitEmailButtonId}
